...
| Browser Client | Browser Client | Fast module and current-browser cross-tab/navigation tests plus cross-browser packaged example flows | Adapter slices |
