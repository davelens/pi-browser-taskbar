...
```elixir
{:pi_browser_taskbar_phoenix, "~> 0.4.2", only: :dev, runtime: false}
```
...
This adapter version is `0.4.2`. Use the same product version shown by the Rails adapter and the root
