...
`pi-browser-taskbar-rails-0.4.2.gem` into an isolated gem home, and rejects a source-workspace
...
conventional application, installs `pi_browser_taskbar_phoenix-0.4.2.tar` through an isolated signed
...
| --- | --- | --- | --- | --- |
| Rails ERB/Turbo | 0.4.2 | Rails 7.1 | MRI Ruby 2.7 | MRI on Linux |
| Phoenix controller-HEEx/LiveView | 0.4.2 | Phoenix 1.7 | Elixir 1.11 | standard Erlang/Elixir runtime on Linux |
